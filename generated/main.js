...
var _stil4m$elm_aui_css$Aui_Avatars$size2class = function (s) {
	...
	switch (_p0.ctor) {
		case 'XSmall':
			return 'aui-avatar-xsmall';
		case 'Small':
			return 'aui-avatar-small';
		case 'Medium':
			return 'aui-avatar-medium';
		case 'Large':
			return 'aui-avatar-large';
		case 'XLarge':
			return 'aui-avatar-xlarge';
		case 'XXLarge':
			return 'aui-avatar-xxlarge';
		default:
			...
			_elm_lang$core$Native_List.fromArray(
				[
					...
					A2(
						...
						'aui-avatar ',
						A2(_elm_lang$core$Basics_ops['++'], projectClass, sizeClass)))
				]),
			_elm_lang$core$Native_List.fromArray(
				[
					A2(
					...
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$html$Html_Attributes$class('aui-avatar-inner')
						]),
					_elm_lang$core$Native_List.fromArray(
						[
							A2(
				...
				[
					...
					_elm_lang$core$Native_List.fromArray(
						[
							...
							ctor: '_Tuple2',
							_0: 'z-index',
							_1: _elm_lang$core$Basics$toString(zIndex)
						},
							{ctor: '_Tuple2', _0: 'opacity', _1: '0.0'},
							{
							ctor: '_Tuple2',
							_0: 'display',
...
var _stil4m$elm_aui_css$Aui_Badges$badge = function (inner) {
	return A3(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html$text(inner)
			]));
};
...
var _stil4m$elm_aui_css$Aui_Buttons$config2buttonClass = function (_p0) {
	...
	var styleClass = function () {
		...
		switch (_p2.ctor) {
			...
			case 'Subtle':
				return 'aui-button aui-button-subtle';
			case 'Link':
				return 'aui-button aui-button-link';
			default:
				return 'aui-button aui-button-light';
		}
	}();
	var styleClass_ = _p1.active ? A2(_elm_lang$core$Basics_ops['++'], styleClass, ' active') : styleClass;
	var _p3 = _p1.additionalClass;
	if (_p3.ctor === 'Nothing') {
		return styleClass_;
	} else {
		return A2(
...
var _stil4m$elm_aui_css$Aui_Buttons$button = F2(
	function (_p4, inner) {
		var _p5 = _p4;
		var _p7 = _p5._0;
		var elem = _p7.forceAnchor ? _elm_lang$html$Html$a : A2(
			...
			A2(
				...
				_p7.href));
		var clickOrDisabledAttrs = _p7.disabled ? _elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$core$Maybe$Just(
				A2(_elm_lang$html$Html_Attributes$attribute, 'aria-disabled', 'true')),
				_elm_lang$core$Maybe$Just(
				_elm_lang$html$Html_Attributes$disabled(true))
			]) : _elm_lang$core$Native_List.fromArray(
			[
				A2(_elm_lang$core$Maybe$map, _elm_lang$html$Html_Attributes$href, _p7.href),
				A2(_elm_lang$core$Maybe$map, _elm_lang$html$Html_Events$onClick, _p7.action)
			]);
		var classAttr = _elm_lang$html$Html_Attributes$class(
			_stil4m$elm_aui_css$Aui_Buttons$config2buttonClass(_p7));
		var attrs = A2(
			_elm_lang$core$List_ops['::'],
			classAttr,
			A2(_elm_lang$core$List$filterMap, _elm_lang$core$Basics$identity, clickOrDisabledAttrs));
...
var _stil4m$elm_aui_css$Aui_Buttons$buttonGroup = function (buttons) {
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html_Attributes$class('aui-buttons')
			]),
		buttons);
};
var _stil4m$elm_aui_css$Aui_Buttons$InnerConfig = F7(
	function (a, b, c, d, e, f, g) {
		return {style: a, forceAnchor: b, disabled: c, href: d, action: e, active: f, additionalClass: g};
	});
...
var _stil4m$elm_aui_css$Aui_Buttons$baseConfig = _stil4m$elm_aui_css$Aui_Buttons$Config(
	{style: _stil4m$elm_aui_css$Aui_Buttons$Normal, forceAnchor: false, disabled: false, href: _elm_lang$core$Maybe$Nothing, action: _elm_lang$core$Maybe$Nothing, active: false, additionalClass: _elm_lang$core$Maybe$Nothing});
var _stil4m$elm_aui_css$Aui_Buttons$disable = function (_p8) {
	var _p9 = _p8;
...
var _stil4m$elm_aui_css$Aui_Buttons$withAction = F2(
	function (action, _p14) {
		var _p15 = _p14;
		return _stil4m$elm_aui_css$Aui_Buttons$Config(
			_elm_lang$core$Native_Utils.update(
				_p15._0,
				{
					action: _elm_lang$core$Maybe$Just(action)
				}));
	});
var _stil4m$elm_aui_css$Aui_Buttons$withActive = F2(
	function (active, _p16) {
		var _p17 = _p16;
		return _stil4m$elm_aui_css$Aui_Buttons$Config(
			_elm_lang$core$Native_Utils.update(
				_p17._0,
...
var _stil4m$elm_aui_css$Aui_Buttons$forceAnchor = function (_p20) {
	var _p21 = _p20;
	return _stil4m$elm_aui_css$Aui_Buttons$Config(
		_elm_lang$core$Native_Utils.update(
			_p21._0,
	...
	function (title, inner) {
		...
		if (_p0.ctor === 'Just') {
			var header = A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Attributes$class('aui-dropdown2-heading')
					]),
				_elm_lang$core$Native_List.fromArray(
					[
						A2(
			...
			return A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Attributes$class('aui-dropdown2-section')
					]),
				A2(_elm_lang$core$List_ops['::'], header, inner));
		} else {
			return A2(
				_elm_lang$html$Html$div,
				_elm_lang$core$Native_List.fromArray(
				...
				[
					...
					_elm_lang$core$Native_List.fromArray(
						[
							...
							_elm_lang$core$Native_List.fromArray(
								[
									{ctor: '_Tuple2', _0: 'z-index', _1: itemsZIndex},
									{ctor: '_Tuple2', _0: 'position', _1: 'relative'}
								]))
						]),
					_elm_lang$core$Native_List.fromArray(
						[
							...
							A2(
								...
								A2(
									_stil4m$elm_aui_css$Aui_Buttons$withAction,
					...
					_elm_lang$core$Native_List.fromArray(
						[
							...
							_elm_lang$core$Native_List.fromArray(
								[
									{ctor: '_Tuple2', _0: 'display', _1: contentDisplay},
									{ctor: '_Tuple2', _0: 'z-index', _1: itemsZIndex},
							...
							_elm_lang$html$Html_Attributes$class('aui-dropdown2 aui-style-default')
						]),
					dropdownInner)
				]));
	});
...
var _stil4m$elm_aui_css$Aui_Expander$expander = F3(
	function (_p7, body, model) {
		...
		return A2(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					_elm_lang$html$Html_Attributes$class('aui-expander-content'),
					A2(
					_elm_lang$html$Html_Attributes$attribute,
					'aria-expanded',
	...
	return A4(
		...
		function (match) {
			return A2(
				_elm_lang$core$Basics_ops['++'],
				'-',
				_elm_lang$core$String$toLower(match.match));
		},
		_elm_lang$core$Basics$toString(i));
};
var _stil4m$elm_aui_css$Aui_Icons$Icon = function (a) {
	return {ctor: 'Icon', _0: a};
};
var _stil4m$elm_aui_css$Aui_Icons$customIcon = _stil4m$elm_aui_css$Aui_Icons$Icon;
var _stil4m$elm_aui_css$Aui_Icons$addIcon = _stil4m$elm_aui_css$Aui_Icons$Icon('add');
var _stil4m$elm_aui_css$Aui_Icons$addCommentIcon = _stil4m$elm_aui_css$Aui_Icons$Icon('add-comment');
var _stil4m$elm_aui_css$Aui_Icons$addSmallIcon = _stil4m$elm_aui_css$Aui_Icons$Icon('add-small');
var _stil4m$elm_aui_css$Aui_Icons$approveIcon = _stil4m$elm_aui_css$Aui_Icons$Icon('approve');
var _stil4m$elm_aui_css$Aui_Icons$appswitcherIcon = _stil4m$elm_aui_css$Aui_Icons$Icon('appswitcher');
var _stil4m$elm_aui_css$Aui_Icons$arrowsDownIcon = _stil4m$elm_aui_css$Aui_Icons$Icon('arrows-down');
var _stil4m$elm_aui_css$Aui_Icons$arrowsLeftIcon = _stil4m$elm_aui_css$Aui_Icons$Icon('arrows-left');
var _stil4m$elm_aui_css$Aui_Icons$arrowsRightIcon = _stil4m$elm_aui_css$Aui_Icons$Icon('arrows-right');
var _stil4m$elm_aui_css$Aui_Icons$arrowsUpIcon = _stil4m$elm_aui_css$Aui_Icons$Icon('arrows-up');
var _stil4m$elm_aui_css$Aui_Icons$attachmentIcon = _stil4m$elm_aui_css$Aui_Icons$Icon('attachment');
var _stil4m$elm_aui_css$Aui_Icons$attachmentSmallIcon = _stil4m$elm_aui_css$Aui_Icons$Icon('attachment-small');
var _stil4m$elm_aui_css$Aui_Icons$autocompleteDateIcon = _stil4m$elm_aui_css$Aui_Icons$Icon('autocomplete-date');
var _stil4m$elm_aui_css$Aui_Icons$backPageIcon = _stil4m$elm_aui_css$Aui_Icons$Icon('back-page');
var _stil4m$elm_aui_css$Aui_Icons$blogrollIcon = _stil4m$elm_aui_css$Aui_Icons$Icon('blogroll');
var _stil4m$elm_aui_css$Aui_Icons$bpDecisionsIcon = _stil4m$elm_aui_css$Aui_Icons$Icon('bp-decisions');
var _stil4m$elm_aui_css$Aui_Icons$bpDefaultIcon = _stil4m$elm_aui_css$Aui_Icons$Icon('bp-default');
var _stil4m$elm_aui_css$Aui_Icons$bpFilesIcon = _stil4m$elm_aui_css$Aui_Icons$Icon('bp-files');
var _stil4m$elm_aui_css$Aui_Icons$bpRequirementsIcon = _stil4m$elm_aui_css$Aui_Icons$Icon('bp-requirements');
var _stil4m$elm_aui_css$Aui_Icons$bpHowtoIcon = _stil4m$elm_aui_css$Aui_Icons$Icon('bp-howto');
var _stil4m$elm_aui_css$Aui_Icons$bpJiraIcon = _stil4m$elm_aui_css$Aui_Icons$Icon('bp-jira');
var _stil4m$elm_aui_css$Aui_Icons$bpMeetingIcon = _stil4m$elm_aui_css$Aui_Icons$Icon('bp-meeting');
var _stil4m$elm_aui_css$Aui_Icons$bpRetrospectiveIcon = _stil4m$elm_aui_css$Aui_Icons$Icon('bp-retrospective');
var _stil4m$elm_aui_css$Aui_Icons$bpSharedlinksIcon = _stil4m$elm_aui_css$Aui_Icons$Icon('bp-sharedlinks');
var _stil4m$elm_aui_css$Aui_Icons$bpTroubleshootingIcon = _stil4m$elm_aui_css$Aui_Icons$Icon('bp-troubleshooting');
var _stil4m$elm_aui_css$Aui_Icons$buildIcon = _stil4m$elm_aui_css$Aui_Icons$Icon('build');
var _stil4m$elm_aui_css$Aui_Icons$calendarIcon = _stil4m$elm_aui_css$Aui_Icons$Icon('calendar');
var _stil4m$elm_aui_css$Aui_Icons$closeDialogIcon = _stil4m$elm_aui_css$Aui_Icons$Icon('close-dialog');
var _stil4m$elm_aui_css$Aui_Icons$collapsedIcon = _stil4m$elm_aui_css$Aui_Icons$Icon('collapsed');
var _stil4m$elm_aui_css$Aui_Icons$commentIcon = _stil4m$elm_aui_css$Aui_Icons$Icon('comment');
var _stil4m$elm_aui_css$Aui_Icons$configureIcon = _stil4m$elm_aui_css$Aui_Icons$Icon('configure');
var _stil4m$elm_aui_css$Aui_Icons$confluenceIcon = _stil4m$elm_aui_css$Aui_Icons$Icon('confluence');
var _stil4m$elm_aui_css$Aui_Icons$copyClipboardIcon = _stil4m$elm_aui_css$Aui_Icons$Icon('copy-clipboard');
var _stil4m$elm_aui_css$Aui_Icons$customBulletIcon = _stil4m$elm_aui_css$Aui_Icons$Icon('custom-bullet');
var _stil4m$elm_aui_css$Aui_Icons$deleteIcon = _stil4m$elm_aui_css$Aui_Icons$Icon('delete');
var _stil4m$elm_aui_css$Aui_Icons$deployIcon = _stil4m$elm_aui_css$Aui_Icons$Icon('deploy');
var _stil4m$elm_aui_css$Aui_Icons$detailsIcon = _stil4m$elm_aui_css$Aui_Icons$Icon('details');
var _stil4m$elm_aui_css$Aui_Icons$docIcon = _stil4m$elm_aui_css$Aui_Icons$Icon('doc');
var _stil4m$elm_aui_css$Aui_Icons$downIcon = _stil4m$elm_aui_css$Aui_Icons$Icon('down');
var _stil4m$elm_aui_css$Aui_Icons$dragVerticalIcon = _stil4m$elm_aui_css$Aui_Icons$Icon('drag-vertical');
var _stil4m$elm_aui_css$Aui_Icons$editIcon = _stil4m$elm_aui_css$Aui_Icons$Icon('edit');
var _stil4m$elm_aui_css$Aui_Icons$editSmallIcon = _stil4m$elm_aui_css$Aui_Icons$Icon('edit-small');
var _stil4m$elm_aui_css$Aui_Icons$emailIcon = _stil4m$elm_aui_css$Aui_Icons$Icon('email');
var _stil4m$elm_aui_css$Aui_Icons$errorIcon = _stil4m$elm_aui_css$Aui_Icons$Icon('error');
var _stil4m$elm_aui_css$Aui_Icons$expandedIcon = _stil4m$elm_aui_css$Aui_Icons$Icon('expanded');
var _stil4m$elm_aui_css$Aui_Icons$fileCodeIcon = _stil4m$elm_aui_css$Aui_Icons$Icon('file-code');
var _stil4m$elm_aui_css$Aui_Icons$fileDocIcon = _stil4m$elm_aui_css$Aui_Icons$Icon('file-doc');
var _stil4m$elm_aui_css$Aui_Icons$fileJavaIcon = _stil4m$elm_aui_css$Aui_Icons$Icon('file-java');
var _stil4m$elm_aui_css$Aui_Icons$filePdfIcon = _stil4m$elm_aui_css$Aui_Icons$Icon('file-pdf');
var _stil4m$elm_aui_css$Aui_Icons$filePptIcon = _stil4m$elm_aui_css$Aui_Icons$Icon('file-ppt');
var _stil4m$elm_aui_css$Aui_Icons$fileTxtIcon = _stil4m$elm_aui_css$Aui_Icons$Icon('file-txt');
var _stil4m$elm_aui_css$Aui_Icons$fileWavIcon = _stil4m$elm_aui_css$Aui_Icons$Icon('file-wav');
var _stil4m$elm_aui_css$Aui_Icons$fileXlsIcon = _stil4m$elm_aui_css$Aui_Icons$Icon('file-xls');
var _stil4m$elm_aui_css$Aui_Icons$fileZipIcon = _stil4m$elm_aui_css$Aui_Icons$Icon('file-zip');
var _stil4m$elm_aui_css$Aui_Icons$flagIcon = _stil4m$elm_aui_css$Aui_Icons$Icon('flag');
var _stil4m$elm_aui_css$Aui_Icons$focusIcon = _stil4m$elm_aui_css$Aui_Icons$Icon('focus');
var _stil4m$elm_aui_css$Aui_Icons$groupIcon = _stil4m$elm_aui_css$Aui_Icons$Icon('group');
var _stil4m$elm_aui_css$Aui_Icons$handleHorizontalIcon = _stil4m$elm_aui_css$Aui_Icons$Icon('handle-horizontal');
var _stil4m$elm_aui_css$Aui_Icons$helpIcon = _stil4m$elm_aui_css$Aui_Icons$Icon('help');
var _stil4m$elm_aui_css$Aui_Icons$hipchatIcon = _stil4m$elm_aui_css$Aui_Icons$Icon('hipchat');
var _stil4m$elm_aui_css$Aui_Icons$homepageIcon = _stil4m$elm_aui_css$Aui_Icons$Icon('homepage');
var _stil4m$elm_aui_css$Aui_Icons$imageIcon = _stil4m$elm_aui_css$Aui_Icons$Icon('image');
var _stil4m$elm_aui_css$Aui_Icons$imageExtrasmallIcon = _stil4m$elm_aui_css$Aui_Icons$Icon('image-extrasmall');
var _stil4m$elm_aui_css$Aui_Icons$imageSmallIcon = _stil4m$elm_aui_css$Aui_Icons$Icon('image-small');
var _stil4m$elm_aui_css$Aui_Icons$infoIcon = _stil4m$elm_aui_css$Aui_Icons$Icon('info');
var _stil4m$elm_aui_css$Aui_Icons$likeIcon = _stil4m$elm_aui_css$Aui_Icons$Icon('like');
var _stil4m$elm_aui_css$Aui_Icons$likeSmallIcon = _stil4m$elm_aui_css$Aui_Icons$Icon('like-small');
var _stil4m$elm_aui_css$Aui_Icons$weblinkIcon = _stil4m$elm_aui_css$Aui_Icons$Icon('weblink');
var _stil4m$elm_aui_css$Aui_Icons$linkIcon = _stil4m$elm_aui_css$Aui_Icons$Icon('link');
var _stil4m$elm_aui_css$Aui_Icons$listAddIcon = _stil4m$elm_aui_css$Aui_Icons$Icon('list-add');
var _stil4m$elm_aui_css$Aui_Icons$listRemoveIcon = _stil4m$elm_aui_css$Aui_Icons$Icon('list-remove');
var _stil4m$elm_aui_css$Aui_Icons$lockedIcon = _stil4m$elm_aui_css$Aui_Icons$Icon('locked');
var _stil4m$elm_aui_css$Aui_Icons$lockedSmallIcon = _stil4m$elm_aui_css$Aui_Icons$Icon('locked-small');
var _stil4m$elm_aui_css$Aui_Icons$macroCodeIcon = _stil4m$elm_aui_css$Aui_Icons$Icon('macro-code');
var _stil4m$elm_aui_css$Aui_Icons$macroDefaultIcon = _stil4m$elm_aui_css$Aui_Icons$Icon('macro-default');
var _stil4m$elm_aui_css$Aui_Icons$macroGalleryIcon = _stil4m$elm_aui_css$Aui_Icons$Icon('macro-gallery');
var _stil4m$elm_aui_css$Aui_Icons$macroStatusIcon = _stil4m$elm_aui_css$Aui_Icons$Icon('macro-status');
var _stil4m$elm_aui_css$Aui_Icons$moreIcon = _stil4m$elm_aui_css$Aui_Icons$Icon('more');
var _stil4m$elm_aui_css$Aui_Icons$navChildrenIcon = _stil4m$elm_aui_css$Aui_Icons$Icon('nav-children');
var _stil4m$elm_aui_css$Aui_Icons$pageBlankIcon = _stil4m$elm_aui_css$Aui_Icons$Icon('page-blank');
var _stil4m$elm_aui_css$Aui_Icons$pageBlogpostIcon = _stil4m$elm_aui_css$Aui_Icons$Icon('page-blogpost');
var _stil4m$elm_aui_css$Aui_Icons$pageDefaultIcon = _stil4m$elm_aui_css$Aui_Icons$Icon('page-default');
var _stil4m$elm_aui_css$Aui_Icons$pageTemplateIcon = _stil4m$elm_aui_css$Aui_Icons$Icon('page-template');
var _stil4m$elm_aui_css$Aui_Icons$pagesIcon = _stil4m$elm_aui_css$Aui_Icons$Icon('pages');
var _stil4m$elm_aui_css$Aui_Icons$quoteIcon = _stil4m$elm_aui_css$Aui_Icons$Icon('quote');
var _stil4m$elm_aui_css$Aui_Icons$redoIcon = _stil4m$elm_aui_css$Aui_Icons$Icon('redo');
var _stil4m$elm_aui_css$Aui_Icons$removeIcon = _stil4m$elm_aui_css$Aui_Icons$Icon('remove');
var _stil4m$elm_aui_css$Aui_Icons$removeLabelIcon = _stil4m$elm_aui_css$Aui_Icons$Icon('remove-label');
var _stil4m$elm_aui_css$Aui_Icons$reviewIcon = _stil4m$elm_aui_css$Aui_Icons$Icon('review');
var _stil4m$elm_aui_css$Aui_Icons$rssIcon = _stil4m$elm_aui_css$Aui_Icons$Icon('rss');
var _stil4m$elm_aui_css$Aui_Icons$searchIcon = _stil4m$elm_aui_css$Aui_Icons$Icon('search');
var _stil4m$elm_aui_css$Aui_Icons$searchSmallIcon = _stil4m$elm_aui_css$Aui_Icons$Icon('search-small');
var _stil4m$elm_aui_css$Aui_Icons$shareIcon = _stil4m$elm_aui_css$Aui_Icons$Icon('share');
var _stil4m$elm_aui_css$Aui_Icons$sidebarLinkIcon = _stil4m$elm_aui_css$Aui_Icons$Icon('sidebar-link');
var _stil4m$elm_aui_css$Aui_Icons$sourcetreeIcon = _stil4m$elm_aui_css$Aui_Icons$Icon('sourcetree');
var _stil4m$elm_aui_css$Aui_Icons$spaceDefaultIcon = _stil4m$elm_aui_css$Aui_Icons$Icon('space-default');
var _stil4m$elm_aui_css$Aui_Icons$spacePersonalIcon = _stil4m$elm_aui_css$Aui_Icons$Icon('space-personal');
var _stil4m$elm_aui_css$Aui_Icons$starIcon = _stil4m$elm_aui_css$Aui_Icons$Icon('star');
var _stil4m$elm_aui_css$Aui_Icons$successIcon = _stil4m$elm_aui_css$Aui_Icons$Icon('success');
var _stil4m$elm_aui_css$Aui_Icons$tableBgIcon = _stil4m$elm_aui_css$Aui_Icons$Icon('table-bg');
var _stil4m$elm_aui_css$Aui_Icons$tableColLeftIcon = _stil4m$elm_aui_css$Aui_Icons$Icon('table-col-left');
var _stil4m$elm_aui_css$Aui_Icons$tableColRemoveIcon = _stil4m$elm_aui_css$Aui_Icons$Icon('table-col-remove');
var _stil4m$elm_aui_css$Aui_Icons$tableColRightIcon = _stil4m$elm_aui_css$Aui_Icons$Icon('table-col-right');
var _stil4m$elm_aui_css$Aui_Icons$tableCopyRowIcon = _stil4m$elm_aui_css$Aui_Icons$Icon('table-copy-row');
var _stil4m$elm_aui_css$Aui_Icons$tableCutRowIcon = _stil4m$elm_aui_css$Aui_Icons$Icon('table-cut-row');
var _stil4m$elm_aui_css$Aui_Icons$tableHeaderColumnIcon = _stil4m$elm_aui_css$Aui_Icons$Icon('table-header-column');
var _stil4m$elm_aui_css$Aui_Icons$tableHeaderRowIcon = _stil4m$elm_aui_css$Aui_Icons$Icon('table-header-row');
var _stil4m$elm_aui_css$Aui_Icons$tableMergeIcon = _stil4m$elm_aui_css$Aui_Icons$Icon('table-merge');
var _stil4m$elm_aui_css$Aui_Icons$tableNoBgIcon = _stil4m$elm_aui_css$Aui_Icons$Icon('table-no-bg');
var _stil4m$elm_aui_css$Aui_Icons$tablePasteRowIcon = _stil4m$elm_aui_css$Aui_Icons$Icon('table-paste-row');
var _stil4m$elm_aui_css$Aui_Icons$tableRemoveIcon = _stil4m$elm_aui_css$Aui_Icons$Icon('table-remove');
var _stil4m$elm_aui_css$Aui_Icons$tableRowDownIcon = _stil4m$elm_aui_css$Aui_Icons$Icon('table-row-down');
var _stil4m$elm_aui_css$Aui_Icons$tableRowRemoveIcon = _stil4m$elm_aui_css$Aui_Icons$Icon('table-row-remove');
var _stil4m$elm_aui_css$Aui_Icons$tableRowUpIcon = _stil4m$elm_aui_css$Aui_Icons$Icon('table-row-up');
var _stil4m$elm_aui_css$Aui_Icons$tableSplitIcon = _stil4m$elm_aui_css$Aui_Icons$Icon('table-split');
var _stil4m$elm_aui_css$Aui_Icons$teamcalsIcon = _stil4m$elm_aui_css$Aui_Icons$Icon('teamcals');
var _stil4m$elm_aui_css$Aui_Icons$timeIcon = _stil4m$elm_aui_css$Aui_Icons$Icon('time');
var _stil4m$elm_aui_css$Aui_Icons$undoIcon = _stil4m$elm_aui_css$Aui_Icons$Icon('undo');
var _stil4m$elm_aui_css$Aui_Icons$unfocusIcon = _stil4m$elm_aui_css$Aui_Icons$Icon('unfocus');
var _stil4m$elm_aui_css$Aui_Icons$unlockedIcon = _stil4m$elm_aui_css$Aui_Icons$Icon('unlocked');
var _stil4m$elm_aui_css$Aui_Icons$unstarIcon = _stil4m$elm_aui_css$Aui_Icons$Icon('unstar');
var _stil4m$elm_aui_css$Aui_Icons$unwatchIcon = _stil4m$elm_aui_css$Aui_Icons$Icon('unwatch');
var _stil4m$elm_aui_css$Aui_Icons$upIcon = _stil4m$elm_aui_css$Aui_Icons$Icon('up');
var _stil4m$elm_aui_css$Aui_Icons$userIcon = _stil4m$elm_aui_css$Aui_Icons$Icon('user');
var _stil4m$elm_aui_css$Aui_Icons$userStatusIcon = _stil4m$elm_aui_css$Aui_Icons$Icon('user-status');
var _stil4m$elm_aui_css$Aui_Icons$viewIcon = _stil4m$elm_aui_css$Aui_Icons$Icon('view');
var _stil4m$elm_aui_css$Aui_Icons$viewCardIcon = _stil4m$elm_aui_css$Aui_Icons$Icon('view-card');
var _stil4m$elm_aui_css$Aui_Icons$viewListIcon = _stil4m$elm_aui_css$Aui_Icons$Icon('view-list');
var _stil4m$elm_aui_css$Aui_Icons$viewTableIcon = _stil4m$elm_aui_css$Aui_Icons$Icon('view-table');
var _stil4m$elm_aui_css$Aui_Icons$warningIcon = _stil4m$elm_aui_css$Aui_Icons$Icon('warning');
var _stil4m$elm_aui_css$Aui_Icons$watchIcon = _stil4m$elm_aui_css$Aui_Icons$Icon('watch');
var _stil4m$elm_aui_css$Aui_Icons$workboxIcon = _stil4m$elm_aui_css$Aui_Icons$Icon('workbox');
var _stil4m$elm_aui_css$Aui_Icons$workboxEmptyIcon = _stil4m$elm_aui_css$Aui_Icons$Icon('workbox-empty');
var _stil4m$elm_aui_css$Aui_Icons$configureColumnsIcon = _stil4m$elm_aui_css$Aui_Icons$Icon('configure-columns');
var _stil4m$elm_aui_css$Aui_Icons$exportIcon = _stil4m$elm_aui_css$Aui_Icons$Icon('export');
var _stil4m$elm_aui_css$Aui_Icons$exportListIcon = _stil4m$elm_aui_css$Aui_Icons$Icon('export-list');
var _stil4m$elm_aui_css$Aui_Icons$fileImageIcon = _stil4m$elm_aui_css$Aui_Icons$Icon('file-image');
var _stil4m$elm_aui_css$Aui_Icons$adminFusionIcon = _stil4m$elm_aui_css$Aui_Icons$Icon('admin-fusion');
var _stil4m$elm_aui_css$Aui_Icons$adminJiraFieldsIcon = _stil4m$elm_aui_css$Aui_Icons$Icon('admin-jira-fields');
var _stil4m$elm_aui_css$Aui_Icons$adminIssueIcon = _stil4m$elm_aui_css$Aui_Icons$Icon('admin-issue');
var _stil4m$elm_aui_css$Aui_Icons$adminNotificationsIcon = _stil4m$elm_aui_css$Aui_Icons$Icon('admin-notifications');
var _stil4m$elm_aui_css$Aui_Icons$adminRolesIcon = _stil4m$elm_aui_css$Aui_Icons$Icon('admin-roles');
var _stil4m$elm_aui_css$Aui_Icons$adminJiraScreensIcon = _stil4m$elm_aui_css$Aui_Icons$Icon('admin-jira-screens');
var _stil4m$elm_aui_css$Aui_Icons$pauseIcon = _stil4m$elm_aui_css$Aui_Icons$Icon('pause');
var _stil4m$elm_aui_css$Aui_Icons$priorityHighestIcon = _stil4m$elm_aui_css$Aui_Icons$Icon('priority-highest');
var _stil4m$elm_aui_css$Aui_Icons$priorityHighIcon = _stil4m$elm_aui_css$Aui_Icons$Icon('priority-high');
var _stil4m$elm_aui_css$Aui_Icons$priorityMediumIcon = _stil4m$elm_aui_css$Aui_Icons$Icon('priority-medium');
var _stil4m$elm_aui_css$Aui_Icons$priorityLowIcon = _stil4m$elm_aui_css$Aui_Icons$Icon('priority-low');
var _stil4m$elm_aui_css$Aui_Icons$priorityLowestIcon = _stil4m$elm_aui_css$Aui_Icons$Icon('priority-lowest');
var _stil4m$elm_aui_css$Aui_Icons$refreshSmallIcon = _stil4m$elm_aui_css$Aui_Icons$Icon('refresh-small');
var _stil4m$elm_aui_css$Aui_Icons$shareListIcon = _stil4m$elm_aui_css$Aui_Icons$Icon('share-list');
var _stil4m$elm_aui_css$Aui_Icons$switchSmallIcon = _stil4m$elm_aui_css$Aui_Icons$Icon('switch-small');
var _stil4m$elm_aui_css$Aui_Icons$versionIcon = _stil4m$elm_aui_css$Aui_Icons$Icon('version');
var _stil4m$elm_aui_css$Aui_Icons$workflowIcon = _stil4m$elm_aui_css$Aui_Icons$Icon('workflow');
var _stil4m$elm_aui_css$Aui_Icons$adminJiraSettingsIcon = _stil4m$elm_aui_css$Aui_Icons$Icon('admin-jira-settings');
var _stil4m$elm_aui_css$Aui_Icons$componentIcon = _stil4m$elm_aui_css$Aui_Icons$Icon('component');
var _stil4m$elm_aui_css$Aui_Icons$reopenIcon = _stil4m$elm_aui_css$Aui_Icons$Icon('reopen');
var _stil4m$elm_aui_css$Aui_Icons$roadmapIcon = _stil4m$elm_aui_css$Aui_Icons$Icon('roadmap');
var _stil4m$elm_aui_css$Aui_Icons$deploySuccessIcon = _stil4m$elm_aui_css$Aui_Icons$Icon('deploy-success');
var _stil4m$elm_aui_css$Aui_Icons$deployFailIcon = _stil4m$elm_aui_css$Aui_Icons$Icon('deploy-fail');
var _stil4m$elm_aui_css$Aui_Icons$fileGenericIcon = _stil4m$elm_aui_css$Aui_Icons$Icon('file-generic');
var _stil4m$elm_aui_css$Aui_Icons$arrowDownIcon = _stil4m$elm_aui_css$Aui_Icons$Icon('arrow-down');
var _stil4m$elm_aui_css$Aui_Icons$arrowUpIcon = _stil4m$elm_aui_css$Aui_Icons$Icon('arrow-up');
var _stil4m$elm_aui_css$Aui_Icons$fileVideoIcon = _stil4m$elm_aui_css$Aui_Icons$Icon('file-video');
var _stil4m$elm_aui_css$Aui_Icons$blogrollLargeIcon = _stil4m$elm_aui_css$Aui_Icons$Icon('blogroll-large');
var _stil4m$elm_aui_css$Aui_Icons$emailLargeIcon = _stil4m$elm_aui_css$Aui_Icons$Icon('email-large');
var _stil4m$elm_aui_css$Aui_Icons$layout1ColLargeIcon = _stil4m$elm_aui_css$Aui_Icons$Icon('layout-1col-large');
var _stil4m$elm_aui_css$Aui_Icons$layout2ColLargeIcon = _stil4m$elm_aui_css$Aui_Icons$Icon('layout-2col-large');
var _stil4m$elm_aui_css$Aui_Icons$layout2ColLeftLargeIcon = _stil4m$elm_aui_css$Aui_Icons$Icon('layout-2col-left-large');
var _stil4m$elm_aui_css$Aui_Icons$layout2ColRightLargeIcon = _stil4m$elm_aui_css$Aui_Icons$Icon('layout-2col-right-large');
var _stil4m$elm_aui_css$Aui_Icons$layout3ColCenterLargeIcon = _stil4m$elm_aui_css$Aui_Icons$Icon('layout-3col-center-large');
var _stil4m$elm_aui_css$Aui_Icons$layout3ColLargeIcon = _stil4m$elm_aui_css$Aui_Icons$Icon('layout-3col-large');
var _stil4m$elm_aui_css$Aui_Icons$navChildrenLargeIcon = _stil4m$elm_aui_css$Aui_Icons$Icon('nav-children-large');
var _stil4m$elm_aui_css$Aui_Icons$pagesLargeIcon = _stil4m$elm_aui_css$Aui_Icons$Icon('pages-large');
var _stil4m$elm_aui_css$Aui_Icons$sidebarLinkLargeIcon = _stil4m$elm_aui_css$Aui_Icons$Icon('sidebar-link-large');
var _stil4m$elm_aui_css$Aui_Icons$teamcalsLargeIcon = _stil4m$elm_aui_css$Aui_Icons$Icon('teamcals-large');
var _stil4m$elm_aui_css$Aui_Icons$userLargeIcon = _stil4m$elm_aui_css$Aui_Icons$Icon('user-large');
var _stil4m$elm_aui_css$Aui_Icons$jiraIssuesIcon = _stil4m$elm_aui_css$Aui_Icons$Icon('jira-issues');
var _stil4m$elm_aui_css$Aui_Icons$devtoolsArrowLeftIcon = _stil4m$elm_aui_css$Aui_Icons$Icon('devtools-arrow-left');
var _stil4m$elm_aui_css$Aui_Icons$devtoolsArrowRightIcon = _stil4m$elm_aui_css$Aui_Icons$Icon('devtools-arrow-right');
var _stil4m$elm_aui_css$Aui_Icons$devtoolsBranchIcon = _stil4m$elm_aui_css$Aui_Icons$Icon('devtools-branch');
var _stil4m$elm_aui_css$Aui_Icons$devtoolsBranchSmallIcon = _stil4m$elm_aui_css$Aui_Icons$Icon('devtools-branch-small');
var _stil4m$elm_aui_css$Aui_Icons$devtoolsBrowseUpIcon = _stil4m$elm_aui_css$Aui_Icons$Icon('devtools-browse-up');
var _stil4m$elm_aui_css$Aui_Icons$devtoolsCheckoutIcon = _stil4m$elm_aui_css$Aui_Icons$Icon('devtools-checkout');
var _stil4m$elm_aui_css$Aui_Icons$devtoolsCloneIcon = _stil4m$elm_aui_css$Aui_Icons$Icon('devtools-clone');
var _stil4m$elm_aui_css$Aui_Icons$devtoolsCommitIcon = _stil4m$elm_aui_css$Aui_Icons$Icon('devtools-commit');
var _stil4m$elm_aui_css$Aui_Icons$devtoolsCompareIcon = _stil4m$elm_aui_css$Aui_Icons$Icon('devtools-compare');
var _stil4m$elm_aui_css$Aui_Icons$devtoolsFileIcon = _stil4m$elm_aui_css$Aui_Icons$Icon('devtools-file');
var _stil4m$elm_aui_css$Aui_Icons$devtoolsFileBinaryIcon = _stil4m$elm_aui_css$Aui_Icons$Icon('devtools-file-binary');
var _stil4m$elm_aui_css$Aui_Icons$devtoolsFileCommentedIcon = _stil4m$elm_aui_css$Aui_Icons$Icon('devtools-file-commented');
var _stil4m$elm_aui_css$Aui_Icons$devtoolsFolderClosedIcon = _stil4m$elm_aui_css$Aui_Icons$Icon('devtools-folder-closed');
var _stil4m$elm_aui_css$Aui_Icons$devtoolsFolderOpenIcon = _stil4m$elm_aui_css$Aui_Icons$Icon('devtools-folder-open');
var _stil4m$elm_aui_css$Aui_Icons$devtoolsForkIcon = _stil4m$elm_aui_css$Aui_Icons$Icon('devtools-fork');
var _stil4m$elm_aui_css$Aui_Icons$devtoolsPullRequestIcon = _stil4m$elm_aui_css$Aui_Icons$Icon('devtools-pull-request');
var _stil4m$elm_aui_css$Aui_Icons$devtoolsRepositoryIcon = _stil4m$elm_aui_css$Aui_Icons$Icon('devtools-repository');
var _stil4m$elm_aui_css$Aui_Icons$devtoolsRepositoryForkedIcon = _stil4m$elm_aui_css$Aui_Icons$Icon('devtools-repository-forked');
var _stil4m$elm_aui_css$Aui_Icons$devtoolsRepositoryLockedIcon = _stil4m$elm_aui_css$Aui_Icons$Icon('devtools-repository-locked');
var _stil4m$elm_aui_css$Aui_Icons$devtoolsSideDiffIcon = _stil4m$elm_aui_css$Aui_Icons$Icon('devtools-side-diff');
var _stil4m$elm_aui_css$Aui_Icons$devtoolsSubmoduleIcon = _stil4m$elm_aui_css$Aui_Icons$Icon('devtools-submodule');
var _stil4m$elm_aui_css$Aui_Icons$devtoolsTagIcon = _stil4m$elm_aui_css$Aui_Icons$Icon('devtools-tag');
var _stil4m$elm_aui_css$Aui_Icons$devtoolsTagSmallIcon = _stil4m$elm_aui_css$Aui_Icons$Icon('devtools-tag-small');
var _stil4m$elm_aui_css$Aui_Icons$devtoolsTaskCancelledIcon = _stil4m$elm_aui_css$Aui_Icons$Icon('devtools-task-cancelled');
var _stil4m$elm_aui_css$Aui_Icons$devtoolsTaskDisabledIcon = _stil4m$elm_aui_css$Aui_Icons$Icon('devtools-task-disabled');
var _stil4m$elm_aui_css$Aui_Icons$devtoolsTaskInProgressIcon = _stil4m$elm_aui_css$Aui_Icons$Icon('devtools-task-in-progress');
var _stil4m$elm_aui_css$Aui_Icons$bitbucketIcon = _stil4m$elm_aui_css$Aui_Icons$Icon('bitbucket');
var _stil4m$elm_aui_css$Aui_Icons$editorAlignCenterIcon = _stil4m$elm_aui_css$Aui_Icons$Icon('editor-align-center');
var _stil4m$elm_aui_css$Aui_Icons$editorAlignLeftIcon = _stil4m$elm_aui_css$Aui_Icons$Icon('editor-align-left');
var _stil4m$elm_aui_css$Aui_Icons$editorAlignRightIcon = _stil4m$elm_aui_css$Aui_Icons$Icon('editor-align-right');
var _stil4m$elm_aui_css$Aui_Icons$editorBoldIcon = _stil4m$elm_aui_css$Aui_Icons$Icon('editor-bold');
var _stil4m$elm_aui_css$Aui_Icons$editorColorIcon = _stil4m$elm_aui_css$Aui_Icons$Icon('editor-color');
var _stil4m$elm_aui_css$Aui_Icons$editorEmoticonIcon = _stil4m$elm_aui_css$Aui_Icons$Icon('editor-emoticon');
var _stil4m$elm_aui_css$Aui_Icons$editorHelpIcon = _stil4m$elm_aui_css$Aui_Icons$Icon('editor-help');
var _stil4m$elm_aui_css$Aui_Icons$editorHrIcon = _stil4m$elm_aui_css$Aui_Icons$Icon('editor-hr');
var _stil4m$elm_aui_css$Aui_Icons$editorIndentIcon = _stil4m$elm_aui_css$Aui_Icons$Icon('editor-indent');
var _stil4m$elm_aui_css$Aui_Icons$editorItalicIcon = _stil4m$elm_aui_css$Aui_Icons$Icon('editor-italic');
var _stil4m$elm_aui_css$Aui_Icons$editorLayoutIcon = _stil4m$elm_aui_css$Aui_Icons$Icon('editor-layout');
var _stil4m$elm_aui_css$Aui_Icons$editorListBulletIcon = _stil4m$elm_aui_css$Aui_Icons$Icon('editor-list-bullet');
var _stil4m$elm_aui_css$Aui_Icons$editorListNumberIcon = _stil4m$elm_aui_css$Aui_Icons$Icon('editor-list-number');
var _stil4m$elm_aui_css$Aui_Icons$editorMacroTocIcon = _stil4m$elm_aui_css$Aui_Icons$Icon('editor-macro-toc');
var _stil4m$elm_aui_css$Aui_Icons$editorMentionIcon = _stil4m$elm_aui_css$Aui_Icons$Icon('editor-mention');
var _stil4m$elm_aui_css$Aui_Icons$editorOutdentIcon = _stil4m$elm_aui_css$Aui_Icons$Icon('editor-outdent');
var _stil4m$elm_aui_css$Aui_Icons$editorStylesIcon = _stil4m$elm_aui_css$Aui_Icons$Icon('editor-styles');
var _stil4m$elm_aui_css$Aui_Icons$editorSymbolIcon = _stil4m$elm_aui_css$Aui_Icons$Icon('editor-symbol');
var _stil4m$elm_aui_css$Aui_Icons$editorTableIcon = _stil4m$elm_aui_css$Aui_Icons$Icon('editor-table');
var _stil4m$elm_aui_css$Aui_Icons$editorTaskIcon = _stil4m$elm_aui_css$Aui_Icons$Icon('editor-task');
var _stil4m$elm_aui_css$Aui_Icons$editorUnderlineIcon = _stil4m$elm_aui_css$Aui_Icons$Icon('editor-underline');
var _stil4m$elm_aui_css$Aui_Icons$jiraIcon = _stil4m$elm_aui_css$Aui_Icons$Icon('jira');
var _stil4m$elm_aui_css$Aui_Icons$jiraCompletedTaskIcon = _stil4m$elm_aui_css$Aui_Icons$Icon('jira-completed-task');
var _stil4m$elm_aui_css$Aui_Icons$jiraTestSessionIcon = _stil4m$elm_aui_css$Aui_Icons$Icon('jira-test-session');
				...
				[
					...
					A2(
						...
						A2(
							_elm_lang$core$Basics_ops['++'],
							sizeClass,
							A2(_elm_lang$core$Basics_ops['++'], ' aui-iconfont', cl))))
				]),
			_elm_lang$core$Native_List.fromArray(
				[]));
	});
...
var _stil4m$elm_aui_css$Aui_Labels$labelRemoveSpan = function (x) {
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html_Attributes$class('aui-label-split-close'),
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Attributes$class('aui-icon aui-icon-close')
					]),
				_elm_lang$core$Native_List.fromArray(
					[]))
			]));
...
var _stil4m$elm_aui_css$Aui_Labels$label = F2(
	function (_p2, inner) {
		...
		var actionAttrs_ = _stil4m$elm_aui_css$Aui_Labels$actionAttrs(_p5);
		var inner_ = function () {
			var _p4 = _p6;
			if (_p4.ctor === 'Nothing') {
				return inner;
		...
		var classString = _elm_lang$core$Native_Utils.eq(_p6, _elm_lang$core$Maybe$Nothing) ? 'aui-label' : 'aui-label aui-label-closeable aui-label-split';
		return A2(
			elem,
			A2(
				_elm_lang$core$List_ops['::'],
				_elm_lang$html$Html_Attributes$class(classString),
				actionAttrs_),
			inner_);
	});
			...
			if (_p1.ctor === 'Nothing') {
				...
				return _elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html_Attributes$class('aui-icon icon-close'),
...
var _stil4m$elm_aui_css$Aui_ProgressIndicator$progressIndicator = function (value) {
	var _p0 = {
		...
		_1: _elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html_Attributes$class('aui-progress-indicator'),
				A2(_elm_lang$html$Html_Attributes$attribute, 'data-value', '')
			])
	};
	var w = _p0._0;
	var attrs = _p0._1;
		...
		return A2(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					...
					_elm_lang$core$Native_List.fromArray(
						[
							{ctor: '_Tuple2', _0: 'width', _1: itemWidth}
						]))
				]),
			_elm_lang$core$Native_List.fromArray(
				[
	...
	function (trackerClass, items, current) {
		var itemWidth = A2(
			...
			_elm_lang$core$Basics$toString(
				100.0 / _elm_lang$core$Basics$toFloat(
		...
		return A2(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					_elm_lang$html$Html_Attributes$class(trackerClass)
				]),
			A2(
...
var _stil4m$elm_aui_css$Aui_Select$inputIdentifier = function (model) {
	return A2(_elm_lang$core$Basics_ops['++'], model.identifier, '__input');
};
		...
		return {
			...
			_0: _elm_lang$core$Native_Utils.update(
				oldModel,
				{
					...
					query: _elm_lang$core$Maybe$Just(newQuery)
				}),
			_1: _elm_lang$core$Platform_Cmd$none
		};
	});
var _stil4m$elm_aui_css$Aui_Select$getAt = F2(
	function (n, list) {
		return A2(
			_elm_lang$core$Maybe$map,
...
var _stil4m$elm_aui_css$Aui_Select$elemIndex = F2(
	function (e, list) {
		return A2(
			_elm_lang$core$Maybe$map,
			_elm_lang$core$Basics$fst,
...
var _stil4m$elm_aui_css$Aui_Select$changeHighlighted = F2(
	function (patch, oldModel) {
		var activeOptionsForModel_ = _stil4m$elm_aui_css$Aui_Select$activeOptionsForModel(oldModel);
		var newHighlighted = function () {
			var _p3 = oldModel.highlighted;
			if (_p3.ctor === 'Nothing') {
				return _elm_lang$core$List$head(activeOptionsForModel_);
			} else {
				var newByIndex = A2(
					_elm_lang$core$Maybe$andThen,
					function (index) {
						return A2(_stil4m$elm_aui_css$Aui_Select$getAt, index + patch, activeOptionsForModel_);
					},
					A2(_stil4m$elm_aui_css$Aui_Select$elemIndex, _p3._0, activeOptionsForModel_));
				var _p4 = newByIndex;
				if (_p4.ctor === 'Nothing') {
					return oldModel.highlighted;
				} else {
					return newByIndex;
				}
			}
...
var _stil4m$elm_aui_css$Aui_Select$initialModel = F2(
...
var _stil4m$elm_aui_css$Aui_Select$Model = F6(
...
var _stil4m$elm_aui_css$Aui_Select$handleOpen = function (model) {
	...
	return {
		...
		_1: A2(
			...
			_elm_lang$core$Basics$always(_stil4m$elm_aui_css$Aui_Select$NoOp),
			_elm_lang$dom$Dom$focus(
				_stil4m$elm_aui_css$Aui_Select$inputIdentifier(model)))
	};
};
var _stil4m$elm_aui_css$Aui_Select$handleSubmit = function (model) {
	var activeOptions_ = _stil4m$elm_aui_css$Aui_Select$activeOptionsForModel(model);
	return {
		ctor: '_Tuple2',
		_0: _elm_lang$core$Native_Utils.update(
			model,
		...
		switch (_p5.ctor) {
			...
			case 'Select':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							value: _elm_lang$core$Maybe$Just(_p5._0),
							open: false,
			...
			case 'Close':
				...
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{value: newValue, open: false}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'ChangeQuery':
				return A2(_stil4m$elm_aui_css$Aui_Select$handleQueryChange, _p5._0, model);
			case 'Submit':
			...
			case 'Hover':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							highlighted: _elm_lang$core$Maybe$Just(_p5._0)
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'Up':
...
var _stil4m$elm_aui_css$Aui_Select$dropDownButton = F2(
	function (zIndex, model) {
		return A2(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					_elm_lang$html$Html_Attributes$class('aui-button'),
					A2(_elm_lang$html$Html_Attributes$attribute, 'role', 'button'),
					_elm_lang$html$Html_Attributes$tabindex(-1),
					_elm_lang$html$Html_Attributes$style(
					_elm_lang$core$Native_List.fromArray(
						[
							{ctor: '_Tuple2', _0: 'z-index', _1: zIndex}
						])),
		...
		return A2(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					...
					_elm_lang$html$Html_Attributes$type_('undefined'),
...
var _stil4m$elm_aui_css$Aui_Select$asOption = F2(
	function (model, opt) {
		...
		return A2(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					A2(_elm_lang$html$Html_Attributes$attribute, 'role', 'option'),
					_elm_lang$html$Html_Attributes$class(
...
var _stil4m$elm_aui_css$Aui_Select$singleSelect = F2(
	function (_p6, model) {
		var _p7 = _p6;
		var _p8 = _p7._0;
		var zIndexItems = _elm_lang$core$Basics$toString(_p8.zIndexBackdrop + 1);
		var activeOptions_ = _stil4m$elm_aui_css$Aui_Select$activeOptionsForModel(model);
		...
		return A2(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					_elm_lang$html$Html_Attributes$id(model.identifier)
				]),
			_elm_lang$core$Native_List.fromArray(
				[
					A3(
					...
					_elm_lang$core$Native_List.fromArray(
						[
							...
							A2(_elm_lang$core$Maybe$withDefault, '', _p8.placeholder)),
							_elm_lang$html$Html_Attributes$tabindex(-1),
							_elm_lang$html$Html_Attributes$style(
							_elm_lang$core$Native_List.fromArray(
								[
					...
					_elm_lang$core$Native_List.fromArray(
						[
							...
							_elm_lang$core$Native_List.fromArray(
								[
									A3(_stil4m$elm_aui_css$Aui_Backdrop$backdrop, _p8.zIndexBackdrop, _stil4m$elm_aui_css$Aui_Select$Close, model.open),
									...
									_elm_lang$core$Native_List.fromArray(
										[
											_elm_lang$html$Html_Attributes$class('aui-popover'),
											_elm_lang$html$Html_Attributes$style(
											_elm_lang$core$Native_List.fromArray(
												[
													{ctor: '_Tuple2', _0: 'position', _1: 'absolute'},
													{ctor: '_Tuple2', _0: 'top', _1: '30px'},
													{ctor: '_Tuple2', _0: 'width', _1: '100%'},
													{ctor: '_Tuple2', _0: 'z-index', _1: zIndexItems},
													{ctor: '_Tuple2', _0: 'display', _1: popoverDisplay}
												]))
										]),
									_elm_lang$core$Native_List.fromArray(
										[
											...
											_elm_lang$core$Native_List.fromArray(
												[
													_elm_lang$html$Html_Attributes$class('aui-optionlist')
												]),
											A2(
												_elm_lang$core$List$map,
	...
	function (cb, model) {
		...
		if (_p0.ctor === 'Nothing') {
			return A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Attributes$class('tabs-pane')
					]),
				_elm_lang$core$Native_List.fromArray(
					[]));
		} else {
			return A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Attributes$class('tabs-pane active-pane')
					]),
				_elm_lang$core$Native_List.fromArray(
					[
						cb(_p0._0)
...
var _stil4m$elm_aui_css$Aui_Tabs$menu = F2(
	function (items, model) {
		return A2(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					_elm_lang$html$Html_Attributes$class('tabs-menu'),
...
var _stil4m$elm_aui_css$Aui_Tabs$tabs = F3(
	function (_p12, cb, model) {
		...
		return A2(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					_elm_lang$html$Html_Attributes$class(tabClass)
				]),
			_elm_lang$core$Native_List.fromArray(
				[
					A2(
...
var _stil4m$elm_aui_css$Aui_Toggle$toggle = F3(
	function (enabled, toMsg, state) {
		var attrs = _elm_lang$core$Native_List.fromArray(
			[]);
		var attrs_ = enabled ? A2(
			_elm_lang$core$List_ops['::'],
			_elm_lang$html$Html_Events$onClick(
				toMsg(!state)),
			attrs) : A2(
			_elm_lang$core$List_ops['::'],
			A2(_elm_lang$html$Html_Attributes$attribute, 'disabled', ''),
			attrs);
		return A3(
			_elm_lang$html$Html$node,
			'aui-toggle',
				...
				[
					...
					_elm_lang$core$Native_List.fromArray(
						[
							...
							_elm_lang$html$Html_Attributes$class('aui-toggle-input'),
							_elm_lang$html$Html_Attributes$checked(state),
							_elm_lang$html$Html_Attributes$disabled(!enabled)
						]),
					_elm_lang$core$Native_List.fromArray(
						[])),
					A2(
					...
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$html$Html_Attributes$class('aui-toggle-view')
						]),
					_elm_lang$core$Native_List.fromArray(
						[
							A2(
							...
							_elm_lang$core$Native_List.fromArray(
								[
									_elm_lang$html$Html_Attributes$class('aui-toggle-tick aui-icon aui-icon-small aui-iconfont-success')
								]),
							_elm_lang$core$Native_List.fromArray(
								[])),
							A2(
							...
							_elm_lang$core$Native_List.fromArray(
								[
									_elm_lang$html$Html_Attributes$class('aui-toggle-cross aui-icon aui-icon-small aui-iconfont-close-dialog')
								]),
							_elm_lang$core$Native_List.fromArray(
								[]))
						]))
...
var _stil4m$elm_aui_css$Aui_Toolbar$toolbar = function (inner) {
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html_Attributes$class('aui-toolbar2'),
				A2(_elm_lang$html$Html_Attributes$attribute, 'role', 'toolbar')
			]),
		_elm_lang$core$Native_List.fromArray(
			[
				A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Attributes$class('aui-toolbar2-inner')
					]),
				inner)
			]));
};
...
var _stil4m$elm_aui_css$Demo_Base$demoSection = F2(
	function (title, content) {
		return A2(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					_elm_lang$html$Html_Attributes$class('aui-page-panel')
				]),
			_elm_lang$core$Native_List.fromArray(
				[
					A2(
					...
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$html$Html_Attributes$class('aui-page-panel-inner')
						]),
					_elm_lang$core$Native_List.fromArray(
						[
							A2(
							...
							_elm_lang$core$Native_List.fromArray(
								[
									_elm_lang$html$Html_Attributes$class('aui-page-panel-content')
								]),
							_elm_lang$core$Native_List.fromArray(
								[
									A2(
									...
									_elm_lang$core$Native_List.fromArray(
										[
											...
											_elm_lang$core$Native_List.fromArray(
												[
													{ctor: '_Tuple2', _0: 'margin', _1: '0 0 15px 0'},
					...
					[
						...
						if (_p1.ctor === 'Just') {
							...
							return A2(
								...
								_elm_lang$core$Native_List.fromArray(
									[
										_elm_lang$html$Html$text('Nothing clicked...')
									]));
						}
					}()
					])),
											...
											[
												...
												_elm_lang$core$Native_List.fromArray(
													[
														...
														_elm_lang$core$Native_List.fromArray(
															[
																_elm_lang$html$Html$text('Red Dwarf')
															]))
													])),
												A2(
												_elm_lang$html$Html$li,
												...
												_elm_lang$core$Native_List.fromArray(
													[
														...
														_elm_lang$core$Native_List.fromArray(
															[
																_elm_lang$html$Html$text('Long Red Dwarf')
															]))
													])),
												A2(
												_elm_lang$html$Html$li,
												...
												_elm_lang$core$Native_List.fromArray(
													[
														...
														_elm_lang$core$Native_List.fromArray(
															[
																_elm_lang$html$Html$text('High Red Dwarf')
															]))
													])),
												A2(
												_elm_lang$html$Html$li,
												...
												_elm_lang$core$Native_List.fromArray(
													[
														...
														_elm_lang$core$Native_List.fromArray(
															[
																_elm_lang$html$Html$text('Nanobot Red Dwarf')
															]))
													]))
											]))
									])),
											...
											[
												...
												_elm_lang$core$Native_List.fromArray(
													[
														...
														_elm_lang$core$Native_List.fromArray(
															[
																_elm_lang$html$Html$text('Starbug')
															]))
													])),
												A2(
												_elm_lang$html$Html$li,
												...
												_elm_lang$core$Native_List.fromArray(
													[
														...
														_elm_lang$core$Native_List.fromArray(
															[
																_elm_lang$html$Html$text('Blue Midget')
															]))
													])),
												A2(
												_elm_lang$html$Html$li,
												...
												_elm_lang$core$Native_List.fromArray(
													[
														...
														_elm_lang$core$Native_List.fromArray(
															[
																_elm_lang$html$Html$text('White Giant')
															]))
													]))
											]))
									])),
											...
											[
												...
												_elm_lang$core$Native_List.fromArray(
													[
														...
														_elm_lang$core$Native_List.fromArray(
															[
																_elm_lang$html$Html$text('Wildfire')
															]))
													])),
												A2(
												_elm_lang$html$Html$li,
												...
												_elm_lang$core$Native_List.fromArray(
													[
														...
														_elm_lang$core$Native_List.fromArray(
															[
																_elm_lang$html$Html$text('SSS Esperanto')
															]))
													])),
												A2(
												_elm_lang$html$Html$li,
												...
												_elm_lang$core$Native_List.fromArray(
													[
														...
														_elm_lang$core$Native_List.fromArray(
															[
																_elm_lang$html$Html$text('Nova 5')
															]))
													]))
											]))
									]))
											...
											[
												...
												_elm_lang$core$Native_List.fromArray(
													[
														...
														_elm_lang$core$Native_List.fromArray(
															[
																_elm_lang$html$Html$text('Content for right aligned')
															]))
													]))
											]))
									]))
...
var _stil4m$elm_aui_css$Demo_Icons$samples = _elm_lang$core$Native_List.fromArray(
	[_stil4m$elm_aui_css$Aui_Icons$addIcon, _stil4m$elm_aui_css$Aui_Icons$customBulletIcon, _stil4m$elm_aui_css$Aui_Icons$arrowsDownIcon, _stil4m$elm_aui_css$Aui_Icons$arrowsLeftIcon, _stil4m$elm_aui_css$Aui_Icons$arrowsRightIcon, _stil4m$elm_aui_css$Aui_Icons$arrowsUpIcon, _stil4m$elm_aui_css$Aui_Icons$layout3ColLargeIcon]);
		...
		[
			...
			_elm_lang$core$Native_List.fromArray(
				[
					...
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$html$Html$text('See the source for more icons')
						]))
				]))
		]));
			...
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html$text('Removed: '),
								_elm_lang$html$Html$text(
								A2(_elm_lang$core$String$join, ', ', model.removedItems))
							])),
						A2(
						_elm_lang$html$Html$p,
						_elm_lang$core$Native_List.fromArray(
		...
		[
			...
			A2(
				...
				A2(
					...
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$html$Html$text('Normal Lozenges')
						])),
				A2(
					_elm_lang$core$List$map,
			...
			A2(
				...
				A2(
					...
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$html$Html$text('Subtle Lozenges')
						])),
				A2(
					_elm_lang$core$List$map,
			...
			_elm_lang$core$Native_List.fromArray(
				[
					...
					_elm_lang$core$Native_List.fromArray(
						[
							{ctor: '_Tuple2', _0: 'padding', _1: '20px'},
							{ctor: '_Tuple2', _0: 'background', _1: '#f5f5f5'}
						]))
				]),
			_elm_lang$core$Native_List.fromArray(
				[
...
var _stil4m$elm_aui_css$Demo_Select$model = function () {
	...
	var selectModel = _p0._0;
	var selectCmds = _p0._1;
	return {
		ctor: '_Tuple2',
	...
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Attributes$class('aui')
					]),
				_elm_lang$core$Native_List.fromArray(
					[
						A2(
	...
	switch (_p0.ctor) {
		...
		case 'Sed':
			return A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text('Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore veritatis et quasi architecto beatae vitae dicta sunt explicabo. Nemo enim ipsam voluptatem quia voluptas sit aspernatur aut odit aut fugit, sed quia consequuntur magni dolores eos qui ratione voluptatem sequi nesciunt. Neque porro quisquam est, qui dolorem ipsum quia dolor sit amet, consectetur, adipisci velit, sed quia non numquam eius modi tempora incidunt ut labore et dolore magnam aliquam quaerat voluptatem. Ut enim ad minima veniam, quis nostrum exercitationem ullam corporis suscipit laboriosam, nisi ut aliquid ex ea commodi consequatur? Quis autem vel eum iure reprehenderit qui in ea voluptate velit esse quam nihil molestiae consequatur, vel illum qui dolorem eum fugiat quo voluptas nulla pariatur?')
					]));
		default:
			return A2(
				_elm_lang$html$Html$div,
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text('At vero eos et accusamus et iusto odio dignissimos ducimus qui blanditiis praesentium voluptatum deleniti atque corrupti quos dolores et quas molestias excepturi sint occaecati cupiditate non provident, similique sunt in culpa qui officia deserunt mollitia animi, id est laborum et dolorum fuga. Et harum quidem rerum facilis est et expedita distinctio. Nam libero tempore, cum soluta nobis est eligendi optio cumque nihil impedit quo minus id quod maxime placeat facere possimus, omnis voluptas assumenda est, omnis dolor repellendus. Temporibus autem quibusdam et aut officiis debitis aut rerum necessitatibus saepe eveniet ut et voluptates repudiandae sint et molestiae non recusandae. Itaque earum rerum hic tenetur a sapiente delectus, ut aut reiciendis voluptatibus maiores alias consequatur aut perferendis doloribus asperiores repellat.')
					]));
	}
};
						...
						[
							...
							_elm_lang$core$Native_List.fromArray(
								[
									...
									_elm_lang$core$Native_List.fromArray(
										[
											A2(_stil4m$elm_aui_css$Aui_Icons$icon, _stil4m$elm_aui_css$Aui_Icons$small, _stil4m$elm_aui_css$Aui_Icons$configureIcon)
										]))
								]))
						]))
				]))
...
var _stil4m$elm_aui_css$Demo_Main$intro = A2(
	...
	_elm_lang$core$Native_List.fromArray(
		[
			...
			_elm_lang$core$Native_List.fromArray(
				[
					_elm_lang$html$Html$text('AUI components ported to Elm.')
				])),
			A2(
			_elm_lang$html$Html$p,
			_elm_lang$core$Native_List.fromArray(
...
var _stil4m$elm_aui_css$Demo_Main$view = function (model) {
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html_Attributes$class('aui-page-focused aui-page-focused-large')
			]),
		_elm_lang$core$Native_List.fromArray(
			[
				A2(
...
var _stil4m$elm_aui_css$Demo_Main$main = _elm_lang$html$Html$program(
	{
...
if (typeof _stil4m$elm_aui_css$Demo_Main$main !== 'undefined') {
    _stil4m$elm_aui_css$Demo_Main$main(Elm['Demo']['Main'], 'Demo.Main', undefined);
}
