...
var _user$project$Aui_Buttons$config2buttonClass = function (_p0) {
	...
	var styleClass$ = _p1.active ? A2(_elm_lang$core$Basics_ops['++'], styleClass, ' active') : styleClass;
...
var _user$project$Aui_Select$changeHighlighted = F2(
	function (patch, oldModel) {
		...
		var newHighlighted = function () {
			...
			if (_p1.ctor === 'Nothing') {
				return _elm_lang$core$List$head(activeOptionsForModel$);
			} else {
				var newByIndex = A2(
					_elm_lang$core$Maybe$andThen,
					A2(_elm_community$elm_list_extra$List_Extra$elemIndex, _p1._0, activeOptionsForModel$),
					function (index) {
						return A2(_elm_community$elm_list_extra$List_Extra$getAt, index + patch, activeOptionsForModel$);
					});
				var _p2 = newByIndex;
				if (_p2.ctor === 'Nothing') {
			...
			case 'Select':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							value: _elm_lang$core$Maybe$Just(_p3._0),
							open: false,
			...
			case 'Hover':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							highlighted: _elm_lang$core$Maybe$Just(_p3._0)
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'Up':
		...
		return A2(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					...
					_elm_lang$html$Html_Attributes$type$('undefined'),
					_elm_lang$html$Html_Attributes$class('text'),
					_elm_lang$html$Html_Attributes$id('mySelect'),
...
var _user$project$Aui_Toggle$toggle = F3(
	function (enabled, toMsg, state) {
		var attrs = _elm_lang$core$Native_List.fromArray(
			[]);
		var attrs$ = enabled ? A2(
			_elm_lang$core$List_ops['::'],
			_elm_lang$html$Html_Events$onClick(
				toMsg(
					_elm_lang$core$Basics$not(state))),
			attrs) : A2(
			_elm_lang$core$List_ops['::'],
...
var _user$project$Demo_Main$ribbon = A2(
	_elm_lang$html$Html$a,
	_elm_lang$core$Native_List.fromArray(
		[
			_elm_lang$html$Html_Attributes$href('https://your-url'),
		...
		[
			...
			_elm_lang$core$Native_List.fromArray(
				[
					...
					A2(_elm_lang$html$Html_Attributes$attribute, 'viewbox', '0 0 250 250'),
					_elm_lang$html$Html_Attributes$style(
					_elm_lang$core$Native_List.fromArray(
						[
							{ctor: '_Tuple2', _0: 'fill', _1: '#151513'},
				...
				[
					...
					_elm_lang$core$Native_List.fromArray(
						[
							...
							_elm_lang$core$Native_List.fromArray(
								[
									{ctor: '_Tuple2', _0: 'transform-origin', _1: '130px 106px;'}
								])),
